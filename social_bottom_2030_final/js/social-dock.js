(function(){
  ...
  function tuneFooter(){
    ...
    wrap.appendChild(el('span','smart-social-footer__hint','روابط التواصل في الشريط السفلي الذكي'));
    footer.appendChild(wrap);
    footer.dataset.smartSocialFooter='1';
  }
  function run(){buildDock();tuneFooter();document.documentElement.classList.add('has-bottom-social-dock');}
